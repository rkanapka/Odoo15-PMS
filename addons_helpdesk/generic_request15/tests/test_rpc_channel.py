...
class TestRequestChannelRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        self.simple_type = self.env.ref('generic_request15.request_type_simple')

        self.channel_api = self.env.ref('generic_request15.request_channel_api')
        self.channel_call = self.env.ref(
            'generic_request15.request_channel_call')
