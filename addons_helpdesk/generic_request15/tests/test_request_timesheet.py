...
class TestWizardLogTime(RequestCase):
    ...
    def setUpClass(cls):
        ...
        cls.activity_id_1 = cls.env.ref(
            'generic_request15.request_timesheet_activity_coding')
        cls.activity_id_2 = cls.env.ref(
            'generic_request15.request_timesheet_activity_analysis')
        cls.user = cls.env.ref('generic_request15.user_demo_request')
