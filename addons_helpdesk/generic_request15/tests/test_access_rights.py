    ...
    def test_130_user_sent_request_manager_confirm(self):
        ...
        request.write({
            'stage_id': self.uenv.ref(
                'generic_request15.request_stage_type_simple_sent').id,
        })
        self.assertEqual(
            request.stage_id,
            self.uenv.ref('generic_request15.request_stage_type_simple_sent'))
        ...
        mrequest.write({
            'stage_id': self.menv.ref(
                'generic_request15.request_stage_type_simple_confirmed').id,
        })
        self.assertEqual(
            mrequest.stage_id,
            self.menv.ref(
