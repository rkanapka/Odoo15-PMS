...
class RequestStage(models.Model):
    ...
    res_bg_color = fields.Char(
        ...
        string="Res Background Color")
    res_label_color = fields.Char(
        compute='_compute_custom_colors',
        readonly=True, string="Res Label Color")
    ...
    def action_show_incoming_routes(self):
        ...
        return self.env['generic.mixin.get.action'].get_action_by_xmlid(
            'generic_request15.action_request_stage_incoming_routes',
            context={
    ...
    def action_show_outgoing_routes(self):
        self.ensure_one()
        return self.env['generic.mixin.get.action'].get_action_by_xmlid(
            'generic_request15.action_request_stage_outgoing_routes',
            context={
