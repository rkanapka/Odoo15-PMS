...
GROUP_USER_ADVANCED = (
    'crnd_wsd15.group_service_desk_website_user_advanced'
)
...
class WebsiteRequest(WSDControllerMixin, http.Controller):
    ...
    def requests(self, req_status='my', page=0, search="", **post):
        ...
        return request.render(
            'crnd_wsd15.wsd_requests', values)
    ...
    def request_new_select_category(self, category_id=None, **kwargs):
        ...
        return request.render(
            "crnd_wsd15.wsd_requests_new_select_category", values)
    ...
    def request_new_select_type(self, type_id=None, category_id=None,
        ...
        return request.render(
            "crnd_wsd15.wsd_requests_new_select_type", values)
    ...
    def _request_new_prepare_data(self, req_type, req_category,
        ...
        channel_website = request.env.ref(
            'generic_request15.request_channel_website')
        res = {
        ...
        if request.httprequest.method == 'POST':
            ...
            if not validation_errors:
                ...
                try:
                    ...
                    return request.render(
                        "crnd_wsd15.wsd_requests_new_congratulation",
                        {'req': req.sudo()})

            values['validation_errors'] = validation_errors
            values.update(req_data)
        return request.render(
            "crnd_wsd15.wsd_requests_new_request_data", values)
