odoo.define('crnd_wsd15.trumbowyg', function (require) {
    'use strict';
    ...
    require('crnd_wsd15.trumbowyg.upload-file');

    // Fix trumbowyg svg icons path
    $.trumbowyg.svgPath = "/crnd_wsd15/static/lib/trumbowyg/dist/ui/icons.svg";
