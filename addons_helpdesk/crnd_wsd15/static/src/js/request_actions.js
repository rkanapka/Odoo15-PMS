odoo.define('crnd_wsd15.request_actions', function (require) {
    'use strict';
    ...
    ajax.loadXML('/crnd_wsd15/static/src/xml/templates.xml', qweb);
    ...
    var RequestActionHelper = snippet_animation.Class.extend({
        ...
        on_request_editor_open: function () {
            ...
            self.$editor_content = $(
                qweb.render('crnd_wsd15.request_text_editor', {
        ...
        on_request_editor_save: function () {
            ...
            blockui.blockUI();
            ajax.jsonRpc(
                '/crnd_wsd15/api/request/update-text',
                'call', {
        ...
        _do_request_action: function (action_id, response_text) {
            ...
            blockui.blockUI();
            ajax.jsonRpc(
                '/crnd_wsd15/api/request/do-action',
                'call', {
                    'request_id': self.request_id,
                    'action_id': action_id,
