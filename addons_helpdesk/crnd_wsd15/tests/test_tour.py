...
class TestWebsiteServiceDesk(TestPhantomTour):
    ...
    def setUp(self):
        ...
        self.user_demo = self.env.ref('crnd_wsd15.user_demo_service_desk_website')
    ...
    def test_tour_request_actions_ok(self):
        ...
        self.env.ref(
            'crnd_wsd15.request_stage_route_type_generic_sent_to_closed'
        ).write({
    ...
    def test_tour_request_actions_not_allowed(self):
        ...
        req_send = self.env.ref(
            'crnd_wsd15.request_stage_route_type_generic_draft_to_sent')
    ...
    @tools.mute_logger('odoo.addons.crnd_wsd15.controllers.main')
    ...
    def test_tour_request_new_default_text(self):
        self.env.ref(
            'crnd_wsd15.request_type_generic'
        ).write({
